<script>
	let snowflake, timestamp
	function reset() {
		snowflake = ''
		update()
	}
	function update() {
		timestamp = snowflake ? new Date(snowflake / 4194304 + 1420070400000) : null
	}
</script>
...
<main>
	...
	<p>
		...
		<a id="help-link">What is a snowflake?</a>
	</p>
	<input
		type="text"
